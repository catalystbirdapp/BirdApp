	...
	private void setMapMarkerInfoWindowAdapter() {
		map.setInfoWindowAdapter(new InfoWindowAdapter() {
			...
			public View getInfoContents(Marker marker) {
				...
				View view = getActivity().getLayoutInflater().inflate(R.layout.map_window_adapter,  mapLayout, false);
				...
				try{
					...
					TextView currentLocationTextView = new TextView(getActivity());
			...
			private void addPictureToMapInfoWindow(View view, String picturePath) {
				...
				if(imgFile.exists()){
				    ...
				    ImageView birdImage = new ImageView(getActivity());
			...
			private void addBirdInfoToMapInfoWindow(String rowTitle, String info) {
				...
				TextView infoTextView = new TextView(getActivity());
		...
		mapSettingsButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View view) {
				if(!settingsOnScreen){
					...
					setSaveButtonOnClickListener(view);
